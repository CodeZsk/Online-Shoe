...
function onlineContainer() {
  ...
  eel.getAllProducts()((product) => renderHot6(product, allhotProduct, "All"));
  ...
  const renderAll6 = (products, container, gender) => {
    ...
    for (let i = 0; i <= 5; i++) {
      if (i == 5) {
        ...
        divMore.style.backgroundImage = `url(${products[i].img[0]})`;
      ...
      containerDiv.setAttribute("data-id", products[i]._id);
  ...
  const renderHot6 = (products, container, gender) => {
    console.log(products);
    let arr = []
    while (arr.length < 6){
      let r = Math.floor(Math.random() * products.length - 1) + 1
  ...
  function determineWords(speech, words) {
    if (words.includes("how are you")) {
      ...
      speech.text =
        "Sneaker Head Hub voice navigator";
    } else if (words.includes("show me shoe")) {
      speech.text = "showing shoes";
      eel.setPageData("All");
      window.location.href = `../section-component/filterpage.html`;
      // shoeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeesssssssssssssssssssssssssssssss
    } else if (words.includes("show me shoes")) {
      speech.text = "showing shoes";
      eel.setPageData("All");
      window.location.href = `../section-component/filterpage.html`;
      // show men shoessssssssssssssssssssssssss
    } else if (words.includes("show men shoes")) {
      speech.text = "showing men shoe";
      eel.setPageData("Men");
      window.location.href = `../section-component/filterpage.html`;
    }else if (words.includes("show men shoe")) {
      speech.text = "showing men shoe";
      eel.setPageData("Men");
      window.location.href = `../section-component/filterpage.html`;
    } else if (words.includes("show me men shoe")) {
      speech.text = "showing men shoe";
      eel.setPageData("Men");
      window.location.href = `../section-component/filterpage.html`;
    }else if (words.includes("show men shoes")) {
    ...
    else if (words.includes("men shoe")) {
      speech.text = "showing men shoe";
      eel.setPageData("Men");
      window.location.href = `../section-component/filterpage.html`;
    } 
    else if (words.includes("men shoes")) {
      speech.text = "showing men shoe";
      eel.setPageData("Men");
      window.location.href = `../section-component/filterpage.html`;
    } 
    ...
    else if (words.includes("women shoe")) {
      speech.text = "showing women shoe";
      eel.setPageData("Women");
      window.location.href = `../section-component/filterpage.html`;
    }
    else if (words.includes("women shoes")) {
      speech.text = "showing women shoe";
      eel.setPageData("Women");
      window.location.href = `../section-component/filterpage.html`;
    }
    else if (words.includes("show me women shoes")) {
      speech.text = "showing women shoe";
      eel.setPageData("Women");
      window.location.href = `../section-component/filterpage.html`;
    } 
    else if (words.includes("show women shoes")) {
      speech.text = "showing women shoe";
      eel.setPageData("Women");
      window.location.href = `../section-component/filterpage.html`;
    }
    ...
    else if (words.includes("show unisex shoe")) {
    ...
    else if (words.includes("unisex shoes")) {
      speech.text = "showing unisex shoe";
      eel.setPageData("Unisex");
      window.location.href = `../section-component/filterpage.html`;
    }
    else if (words.includes("unisex shoe")) {
      speech.text = "showing unisex shoe";
      eel.setPageData("Unisex");
      window.location.href = `../section-component/filterpage.html`;
    }
    else if (words.includes("show me unisex shoes")) {
      speech.text = "showing unisex shoe";
      eel.setPageData("Unisex");
      window.location.href = `../section-component/filterpage.html`;
    } 
      ...
      window.location.href = `../setting-component/setting.html`;
      // proooooooofileeeeeeeeeeeeeeeeeeeee
      ...
      eel.setBackPageData("Home");
      window.location.href = `../setting-component/setting.html`;
    }  else if (words.includes("profiles")) {
      speech.text = "opening profile";
      eel.setBackPageData("Home");
      window.location.href = `../setting-component/setting.html`;
      ...
      eel.setBackPageData("Home");
      window.location.href = `../setting-component/setting.html`;
      // faqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq
      ...
      speech.text = "krishna created me and Thanks to him";
      // Faqqqqqqqqqqqqqqqq
    } else if (words.includes("open FAQ")) {
    ...
    // about us
      ...
      window.location.href = `../setting-component/setting.html`;
    }else if (words.includes("open contact us")) {
      speech.text = "click on contact us";
      window.location.href = `../setting-component/setting.html`;
    } else if (words.includes("show contact us")) {
      speech.text = "click on contact us";
      window.location.href = `../setting-component/setting.html`;
    } else if (words.includes("where is contact us")) {
      speech.text = "click on contact us";
      window.location.href = `../setting-component/setting.html`;
    } else if (words.includes("where is contact us")) {
      speech.text = "click on contact us";
      window.location.href = `../setting-component/setting.html`;
    } else if (words.includes("what is contact us")) {
      speech.text = "click on contact us to know more";
      window.location.href = `../setting-component/setting.html`;
    } else if (words.includes("contact us")) {
      speech.text = "click on contact us to know more";
      window.location.href = `../setting-component/setting.html`;
    }else if (words.includes("about us")) {
      speech.text = "click on about us";
      window.location.href = `../setting-component/setting.html`;
    }else if (words.includes("open FAQ")) {
      speech.text = "click on FAQ";
